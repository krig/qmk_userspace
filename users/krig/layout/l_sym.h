...
#define L_SYM_L2 KC_QUOT, KC_MINS, KC_UNDS,  KC_EQL,   KC_AT
#define L_SYM_L3 KC_DQUO, KC_PLUS, KC_ASTR, KC_SLSH, KC_TILD

#define L_SYM_R0 SQ_PIPE, SQ_AMPR, SQ_LTAR, SQ_RTAR, SQ_PHEX

#define L_SYM_R1 KC_BSLS, KC_AMPR, KC_LBRC, KC_RBRC, KC_QUES
#define L_SYM_R2 KC_PIPE, KC_COLN, KC_LPRN, KC_RPRN, KC_SCLN
#define L_SYM_R3 KC_CIRC,  KC_DLR, KC_LCBR, KC_RCBR, KC_EXLM
