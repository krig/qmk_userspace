...
#define QWERTY_R1 KC_J, KC_Y, KC_O, KC_U, KC_COMM
...
#define QWERTY_R3 KC_Z, KC_W, CMD_T(KC_SQUO), CTL_T(KC_SLSH), ALT_T(KC_DOT)

#else

#define QWERTY_L3 KC_X, KC_F, KC_L, LT(_NUM, KC_D), KC_B
#define QWERTY_R3 KC_Z, KC_W, KC_SQUO, KC_SLSH, KC_DOT
